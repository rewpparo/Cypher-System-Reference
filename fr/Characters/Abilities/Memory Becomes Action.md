...
want to copy a friend’s Lunge attack (which normally costs 2 Might points),
you’d pay 4 Intellect points to activate Memory Becomes Action and 2 Might
points to use Lunge. In addition to the normal options for using Effort, you can
