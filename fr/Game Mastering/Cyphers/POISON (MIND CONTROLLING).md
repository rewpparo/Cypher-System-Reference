...
Effect: The victim must carry out a specific action in response to a specific
trigger. Roll a d100 to determine the action.
...
| 76–85 | Obeys next verbal command given <br>(if it is understood).                                                          |
| 86–95 | For one day, becomes sexually attracted to the next creature of its own species that it sees.                       |
| 96–00 | For one minute, moves toward the next red object seen in lieu of all other actions, ignoring <br>self-preservation. |
