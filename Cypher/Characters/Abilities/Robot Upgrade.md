...
You modify your artificial assistant from the [Robot Assistant](Robot%20Assistant.md) ability with one new capability. Standard options include the following. Work with your GM if you prefer a different capability.
