...
- Tier 3: [Master Crafter](../Abilities/Master%20Crafter.md) or [Built-in Weaponry](../Abilities/Built-in%20Weaponry.md)
- Tier 4: [Cyphersmith](../Abilities/Cyphersmith.md)
- Tier 5: [Innovator](../Abilities/Innovator.md)
- Tier 6: [Inventor](../Abilities/Inventor.md) or [Fusion Armor](../Abilities/Fusion%20Armor.md)

GM Intrusions: The object malfunctions, breaks, or suffers catastrophic or unexpected failure.

([Cyphersmith](../Abilities/Cyphersmith.md) works only in a setting where the cyphers are physical objects. If this isn’t the case, this ability should probably be replaced with something akin to [Weird Science Breakthrough](../Abilities/Weird%20Science%20Breakthrough.md) from the [Conducts Weird Science](Conducts%20Weird%20Science.md) focus.)
